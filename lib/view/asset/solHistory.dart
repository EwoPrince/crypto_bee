...
class SOLHistory extends ConsumerStatefulWidget {
  const SOLHistory({super.key});

  @override
  ConsumerState<SOLHistory> createState() => _SOLHistoryState();
}

class _SOLHistoryState extends ConsumerState<SOLHistory> {
