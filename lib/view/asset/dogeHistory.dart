...
class DogeHistory extends ConsumerStatefulWidget {
  const DogeHistory({super.key});

  @override
  ConsumerState<DogeHistory> createState() => _DogeHistoryState();
}

class _DogeHistoryState extends ConsumerState<DogeHistory> {
    ...
    return Center(
      child: FutureBuilder(
          ...
          builder: (context, snapshot) {
            ...
            final newdata = data
                .where((element) =>
                    element.transcationId.isNotEmpty && element.DOGE != 0)
                .toList();
