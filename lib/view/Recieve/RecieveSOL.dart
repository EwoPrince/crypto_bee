    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 20),
          const Text('Send only Solana to this address'),
              ...
              builder: (context, snapshot) {
                ...
                if (snapshot.data == true) {
                  return buildWalletUI(
                    address: 'DrGaTCLkQAwhuAVYbWbjEeV7xsJ7cAkPf7dw7ui85xcM',
                    qrImage: 'assets/images/sol_address.jpeg',
                    context: context,
                  );
                }
                if (snapshot.data == false) {
                  return buildWalletUI(
                    address: '4ZziiyJvdqd6GBLzfw1r6ugvkQqmaoVRrRN3uArNJhaJ',
                    qrImage: 'assets/images/sol_address_2.jpeg',
                    context: context,
                  );
                }
                return const Center(
