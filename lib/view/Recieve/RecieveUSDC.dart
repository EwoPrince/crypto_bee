...
class RecieveUSDC extends StatefulWidget {
  const RecieveUSDC({super.key});
  static const routeName = '/RecieveUSDC';

  @override
  State<RecieveUSDC> createState() => _RecieveBTCState();
}

class _RecieveBTCState extends State<RecieveUSDC> {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 20),
          const Text('Send only USDC to this address'),
              ...
              builder: (context, snapshot) {
                ...
                if (snapshot.data == true) {
                  return buildWalletUI(
                    ...
                    qrImage: 'assets/images/usdc_address.jpeg',
                    context: context,
                  );
                }
