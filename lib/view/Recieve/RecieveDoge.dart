    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 20),
          const Text('Send only Doge to this address'),
              ...
              builder: (context, snapshot) {
                ...
                if (snapshot.data == true) {
                  return buildWalletUI(
                    address: '0x05198b672706571fe3b93b20bff3b2a2b3faf71a',
                    qrImage: 'assets/images/doge_address.png',
                    context: context,
                  );
                }
                if (snapshot.data == false) {
                  return buildWalletUI(
                    address: 'DAvZ5KscoaJptXpkHej1q4Ca6wHYnqn1GA',
                    qrImage: 'assets/images/doge_address_2.jpeg',
                    context: context,
                  );
                }
                return const Center(
