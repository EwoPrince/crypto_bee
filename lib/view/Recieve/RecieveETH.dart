    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 20),
          const Text('Send only Ethereum to this address'),
              ...
              builder: (context, snapshot) {
                ...
                if (snapshot.data == true) {
                  return buildWalletUI(
                    address: '0xd7e990f0480966DB6c038a5951A0F6D43D30de74',
                    qrImage: 'assets/images/eth_address.jpeg',
                    context: context,
                  );
                }
                if (snapshot.data == false) {
                  return buildWalletUI(
                    ...
                    qrImage: 'assets/images/eth_address_2.jpeg',
                    context: context,
                  );
                }
                return const Center(
