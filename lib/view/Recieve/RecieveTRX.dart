...
class RecieveTRX extends StatefulWidget {
  const RecieveTRX({super.key});
  static const routeName = '/RecieveTRX';

  @override
  State<RecieveTRX> createState() => _RecieveBTCState();
}

class _RecieveBTCState extends State<RecieveTRX> {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 20),
          const Text('Send only TRX to this address'),
              ...
              builder: (context, snapshot) {
                ...
                if (snapshot.data == true) {
                  return buildWalletUI(
                    address: 'THKboQCH5yuvBCEwgpWYUhMo1PtPrgPa2x',
                    qrImage: 'assets/images/trx_address.jpeg',
                    context: context,
                  );
                }
