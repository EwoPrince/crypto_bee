...
class RecieveX extends StatefulWidget {
  const RecieveX({super.key});
  static const routeName = '/RecieveX';

  @override
  State<RecieveX> createState() => _RecieveBTCState();
}

class _RecieveBTCState extends State<RecieveX> {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 20),
          const Text('Send only X to this address'),
              ...
              builder: (context, snapshot) {
                ...
                if (snapshot.data == true) {
                  return buildWalletUI(
                    ...
                    qrImage: 'assets/images/x_address.jpeg',
                    context: context,
                  );
                }
