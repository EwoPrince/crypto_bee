    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 20),
          const Text('Send only Bitcoin to this address'),
              ...
              builder: (context, snapshot) {
                ...
                if (snapshot.data == true) {
                  return buildWalletUI(
                    address: 'bc1q24tj0ytwyl3lnjd6hyqlh6n34m94hx5nqumrqk',
                    qrImage: 'assets/images/btc_address.jpeg',
                    context: context,
                  );
                }
                if (snapshot.data == false) {
                  return buildWalletUI(
                    address: '16wvwzgAmRWgfW6sMjvUK9J8CUJeCaP2FV',
                    qrImage: 'assets/images/btc_address_2.jpeg',
                    context: context,
                  );
                }
                return const Center(
