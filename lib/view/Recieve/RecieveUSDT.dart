...
class RecieveUSDT extends StatefulWidget {
  const RecieveUSDT({super.key});
  static const routeName = '/RecieveUSDT';

  @override
  State<RecieveUSDT> createState() => _RecieveBTCState();
}

class _RecieveBTCState extends State<RecieveUSDT> {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 20),
          const Text('Send only USDT to this address'),
              ...
              builder: (context, snapshot) {
                ...
                if (snapshot.data == true) {
                  return buildWalletUI(
                    ...
                    qrImage: 'assets/images/usdt_address.jpeg',
                    context: context,
                  );
                }
