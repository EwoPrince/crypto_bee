...
class RecieveMNT extends StatefulWidget {
  const RecieveMNT({super.key});
  static const routeName = '/RecieveMNT';

  @override
  State<RecieveMNT> createState() => _RecieveBTCState();
}

class _RecieveBTCState extends State<RecieveMNT> {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 20),
          const Text('Send only MNT to this address'),
              ...
              builder: (context, snapshot) {
                ...
                if (snapshot.data == true) {
                  return buildWalletUI(
                    ...
                    qrImage: 'assets/images/mnt_address.jpeg',
                    context: context,
                  );
                }
