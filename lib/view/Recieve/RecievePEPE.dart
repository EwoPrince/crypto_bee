...
class RecievePEPE extends StatefulWidget {
  const RecievePEPE({super.key});
  static const routeName = '/RecievePEPE';

  @override
  State<RecievePEPE> createState() => _RecieveBTCState();
}

class _RecieveBTCState extends State<RecievePEPE> {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 20),
          const Text('Send only PEPE to this address'),
              ...
              builder: (context, snapshot) {
                ...
                if (snapshot.data == true) {
                  return buildWalletUI(
                    address: 'Ox5f2bb016701d6a3245ada5bef024344d1300ee21',
                    qrImage: 'assets/images/pepe_address.jpeg',
                    context: context,
                  );
                }
